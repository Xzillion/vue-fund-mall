<template>
    <div class="hs-passwordView" v-show="showPasswordView">
...
<script>
    export default {
        ...
        created() {
            this.$bus.on('showPasswordView', data=> {
                this.doStatus = 0;
                this.code = [];
                this.resultMess = '';
            ...
            this.$bus.on('hidePasswordView', data=> {
        ...
        methods: {
            ...
            getMessClass() {
                return {
                    "icon-done image": this.doStatus != 1,
                    "icon-validate checkImage": this.doStatus === 1
                };
            }
        }
    };
