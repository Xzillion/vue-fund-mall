/**
 * vue router by zouxiang 官网地址https://router.vuejs.org/zh-cn/index.html
 */
import Vue from 'vue'
...
const routes = [
  ...
  */
  ...
  /* 银行卡列表选择页面 */
  {
    path: '/showBankCardList',
    name: 'showBankCardList',
    component: r => require.ensure([], () => r(require('src/views/mine/ShowBankCardList')), 'default')
  },
  /* 选择我的银行卡 */
  {
    path: '/selectBankCard',
  ...
  /* 查看协议 */
  {
    path: '/watchAgreement',
    name: 'watchAgreement',
    component: r => require.ensure([], () => r(require('src/views/template/WatchAgreement')), 'default')
  },
  /* 修改交易密码 */
  {
    path: '/changeTradePwd',
