<template>
    <div id="fundDetails">
        <title-bar :title="fundName" :subTitle="fundAccount" :isColorful="true">
            <a href="tel:17681820453" style="color: #fff">
                ...
                <div class="num-box">
                    ...
                    <div class="item">
                        <div class="top top-up">
                            <span class="top-value" v-percent="{val: '0.0156'}"></span>
                        </div>
            ...
            <div class="detail-box">
                ...
                <div class="returns-pan" v-show="!isShowMovement">
                    ...
                    <div class="content-pan" v-for="(item, index) in earningsList" :key="index">
                        ...
                        <span class="item" v-rateofpercent="{val: item.daliyIncrease}"></span>
                    </div>
                    <div class="more" @click="goPage('/fundValueHistory')">查看更多</div>
                </div>
            </div>
            <div class="other-group">
                <line-cell title="基金概况" text="华夏基金管理有限公司" url="/fundSituation"></line-cell>
                <line-cell title="基金经理" text="王霄、小小明" url="/fundManager"></line-cell>
        ...
        <div class="bottom-box">
            ...
            <div class="button-box">
                <div class="add" @click="addOptional">
                    <span class="iconfont add-icon" :class="optionalIcon()"></span>
    ...
    export default {
        ...
        data() {
            return {
                ...
                setting: {},
                earningsList: [
                    {date: '2017-01-02', unitValue: '1.2103', allValue: '2.5163', daliyIncrease: '0.0664'},
                    {date: '2017-01-02', unitValue: '1.3103', allValue: '3.5163', daliyIncrease: '-0.0234'},
                    {date: '2017-01-02', unitValue: '1.4103', allValue: '4.5163', daliyIncrease: '0.0214'},
                    {date: '2017-01-02', unitValue: '1.5103', allValue: '5.5163', daliyIncrease: '-0.0434'}                    
                ],
                dateList: [{
                        text: '近1月',
                        active: true
        ...
        methods: {
            optionalIcon() {
                return this.optional? 'icon-star' : 'icon-Pentagon';
            },
            /* 自选按钮 */
            addOptional() {
