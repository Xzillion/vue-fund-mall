    ...
    <div id="myInformation">
        ...
        <div class="main-column-box">
            <div class="group-box">
                ...
                <line-cell title="证件号码" :text="IDCard | formatIDCard"></line-cell>
            </div>
            <div class="group-box">
                <line-cell title="手机号码" :text="phone | formatMobile" :isLink="true" @tapItem="tapItem"></line-cell>
                <line-cell title="电子邮箱" :text="email | formatEmail" :isLink="true" @tapItem="tapItem"></line-cell>
