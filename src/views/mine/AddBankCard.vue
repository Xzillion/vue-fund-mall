        ...
        <div class="main-column-box">
            ...
            <div class="person-box">
                <div class="item-line">
                    ...
                    <input class="right-text" v-model="name" placeholder="请输入真实姓名" v-focus>
            ...
            <div class="card-box">
                <div class="item-line" @click="chooseBank">
                    ...
                    <span class="middle-text" :style="getBankColor()">{{bankName}}</span>
...
<script>
    ...
    export default {
        ...
        mounted() {
            var bankObj = utils.getData('selectedbankObj');
            this.bankName = bankObj.name || '请选择银行';            
        },
        methods: {
            getBankColor() {
                var color = this.bankName === '请选择银行'? '#cdcdcd' : '#333';
                return {color};
            },
            chooseBank() {
                APP.openWin('/showBankCardList');
            },
            goNext() {
            ...
            watchAgreen() {
                ...
                APP.openWin('watchAgreement', {title: '快捷支付服务协议'});
            }
        }
    }
</script>
